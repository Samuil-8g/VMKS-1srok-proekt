...
void setup() {
  delay(50); // Just in case, wait some time for LCD and accelerometer to "boot"
...
/* Three parameters have to be set for activity:
    ...
    3. Threshold in g
*/
  myAcc.setActivityParameters(ADXL345_DC_MODE, ADXL345_XYZ, 1.5);
...
*/  
//  myAcc.setInactivityParameters(ADXL345_DC_MODE, ADXL345_XYZ, 0.5, 10.0);
...
*/
  ...
  //myAcc.setInterrupt(ADXL345_INACTIVITY, INT_PIN_1);
